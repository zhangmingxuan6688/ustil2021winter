...
public:
	...
	normal(string sender, string receiver, string address, double weight) :Package(weight, sender, receiver, address) {
		cout << "普通包裹的重量：" << weight << endl;
		cout << "普通包裹发件人：" << sender << endl;
		cout << "普通包裹收件人：" << receiver << endl;
		cout << "普通包裹收件地：" << address << endl;
		firstcost = 20;
		overcost = 5;
		firstweight = 10;
	}
...
public:
	...
	hurry(double weight, string sender, string receiver, string address, double distance) :Package(weight, sender, receiver, address) {
		cout << "加急包裹的重量：" << weight << endl;
		cout << "加急包裹发件人：" << sender << endl;
		cout << "加急包裹收件人：" << receiver << endl;
		cout << "加急包裹收件地：" << address << endl;
		firstprice = 50;
